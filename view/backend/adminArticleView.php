...
<div class="articles">
    <h3>
        <?= htmlspecialchars($article['titre']) ?> <br> publié le <em> <?= $article['date_creation'] ?></em>
    </h3>
...
<div class="commentaires">
    <p>
        <strong><?= htmlspecialchars($commentaire['auteur']) ?></strong> a commenté le <?= $commentaire['date_commentaire'] ?>
    </p>

    <p class="commentaireContenu">
