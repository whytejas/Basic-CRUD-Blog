...
<div>
    ...
    <ul>
        ...
        <span>
            <a href="./adminIndex.php?action=deleteCommentaire&id=<?php echo $commentsSignales['id']; ?>&articleId=<?php echo $commentsSignales['id_article']; ?>" onclick="return confirm('Êtes-vous sûr et certain? Cette action est permanente !')"> Supprimer</a>
        </span>
